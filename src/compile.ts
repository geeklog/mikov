 ...
 * import { x } from './abc'
 */
export function convertRequireToES6Import(s: string) {
 ...
 * export default m;
 */
export function convertES5ModuleExportsToES6ExportDefault(s: string) {
 ...
 * export function a(...) {
 */
export function convertES5ExportsFunctionToES6ExportFunction(s: string) {
 ...
 */
export function convertExportArrowFunction(s: string) {
...
export function convertES5ToEs6(src: string) {
  return src.split('\n')
    .map(
      oneOf([
